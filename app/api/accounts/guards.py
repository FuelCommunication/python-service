...
def requires_verified_user(connection: ASGIConnection[UsersModel, any, any, any], _: BaseRouteHandler) -> None:
...
async def current_user_from_token(token: Token, connection: ASGIConnection[any, any, any, any]) -> UsersModel | None:
...
auth = OAuth2PasswordBearerAuth[UsersModel](
